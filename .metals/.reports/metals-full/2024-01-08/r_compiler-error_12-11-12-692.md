...
public class Client {
    ...
    public void damage(){
        try {
            ...
            gameSpace.get(new ActualField("request"), new ActualField("damage"), new FormalField(Integer.class), new FormalField(Integer.class));
            System.out.println(gameSpace.hashCode());

        } catch (Exception e) {
            System.o@@ut.println("Could not deal damage");
        }
    }
